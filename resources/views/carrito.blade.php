...
<div class="modal fade" id="aboutModal" tabindex="-1" aria-labelledby="aboutModalLabel" aria-hidden="true">
  ...
  <div class="p-3" style="background-color: rgba(31, 41, 55, 1); color: rgba(209, 213, 219, 1); border-radius: 15px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
    <h5 class="text-center" style="color: rgba(229, 231, 235, 1);">Filtros</h5>
    <form method="GET" action="{{ route('productos.index') }}">
      <div class="form-group mb-4">
        <label class="fw-bold" style="color: rgba(229, 231, 235, 1);">Categoría</label>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" name="category[]" value="portatiles" id="portatiles">
          <label class="form-check-label" for="portatiles" style="color: rgba(209, 213, 219, 0.8);">Portátiles</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" name="category[]" value="escritorio" id="escritorio">
          <label class="form-check-label" for="escritorio" style="color: rgba(209, 213, 219, 0.8);">Escritorio</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" name="category[]" value="teclados" id="teclados">
          <label class="form-check-label" for="teclados" style="color: rgba(209, 213, 219, 0.8);">Teclados</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" name="category[]" value="mouses" id="mouses">
          <label class="form-check-label" for="mouses" style="color: rgba(209, 213, 219, 0.8);">Mouses</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" name="category[]" value="audifonos" id="audifonos">
          <label class="form-check-label" for="audifonos" style="color: rgba(209, 213, 219, 0.8);">Audífonos</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" name="category[]" value="monitores" id="monitores">
          <label class="form-check-label" for="monitores" style="color: rgba(209, 213, 219, 0.8);">Monitores</label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" name="category[]" value="controles" id="controles">
          <label class="form-check-label" for="controles" style="color: rgba(209, 213, 219, 0.8);">Controles</label>
        </div>
      </div>

      <button type="submit" class="btn w-100" style="background-color: rgba(229, 231, 235, 1); color: rgba(31, 41, 55, 1); border: none;">Filtrar</button>
    </form>
  </div>
</div>
      ...
      <div class="col-md-4 col-sm-6 mb-4 d-flex justify-content-center">
        <div class="card text-center" style="background-color: rgba(31, 41, 55, 1); border-radius: 15px; color: rgba(209, 213, 219, 1); width: 300px; height: 490px;">
          ...
          <div class="card-body d-flex flex-column">
            <h5 class="card-title" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;">{{ $product->name }}</h5>
            <p class="card-text">Precio: ${{ number_format($product->price, 2) }}</p>
            <p class="card-text">Stock: {{ $product->stock }}</p>
            <a href="#" class="btn btn-primary mt-auto" style="background-color: rgba(229, 231, 235, 1); color: rgba(31, 41, 55, 1); border: none; width: 100%;">Comprar</a>
          </div>
        </div>
      </div>
    @endforeach
