...
<div class="container my-5">
    <h2 class="text-center mb-4">Productos de la categoría Controles</h2>

    <!-- Botón para abrir el modal -->
    <button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#createControlModal">
        Crear Nuevo Producto
    </button>

    <!-- Modal para crear un nuevo producto en la categoría Controles -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content bg-dark text-light">
                <div class="modal-header">
                    <h5 class="modal-title" id="createControlModalLabel">Crear Nuevo Producto - Controles</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <input type="hidden" name="category" value="controles">
    ...
    <!-- Lista de productos existentes en la categoría Controles -->
    <div class="row">
