...
<div class="container my-5">
    <h2 class="text-center mb-4">Productos de la categoría Teclados</h2>

    <!-- Botón para abrir el modal de creación -->
    <button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#createTecladoModal">
        Crear Nuevo Producto
    </button>

    <!-- Modal para crear un nuevo producto en la categoría Teclados -->
    <div class="modal fade" id="createTecladoModal" tabindex="-1" aria-labelledby="createTecladoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="background-color: rgba(31, 41, 55, 1); color: rgba(209, 213, 219, 1);">
                <div class="modal-header">
                    <h5 class="modal-title" id="createTecladoModalLabel">Crear Nuevo Producto - Teclados</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <input type="hidden" name="category" value="teclados">
    ...
    <!-- Lista de productos existentes en la categoría Teclados -->
    <div class="row">
